...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc -shared -fno-semantic-interposition  '
              '-fno-semantic-interposition',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'armv7-alpine-linux-musleabihf',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
           '-fomit-frame-pointer -g -fno-semantic-interposition  '
           '-fomit-frame-pointer -g -fno-semantic-interposition '
           '-fomit-frame-pointer -g -fno-semantic-interposition '
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-fomit-frame-pointer -g -fno-semantic-interposition',
 'CONFIGURE_CFLAGS_NODIST': '-flto=4 -fuse-linker-plugin -ffat-lto-objects '
 ...
 'CONFIGURE_LDFLAGS_NODIST': '-flto=4 -fuse-linker-plugin -ffat-lto-objects '
                             '-flto-partition=none -g',
 'CONFIG_ARGS': "'--build=armv7-alpine-linux-musleabihf' "
                "'--host=armv7-alpine-linux-musleabihf' '--prefix=/usr' "
                ...
                "'--with-bluetoothdir=/home/buildozer/aports/main/python3/src/bluez-5.55' "
                "'build_alias=armv7-alpine-linux-musleabihf' "
                "'host_alias=armv7-alpine-linux-musleabihf' 'CC=gcc' 'CFLAGS= "
                "-fomit-frame-pointer -g -fno-semantic-interposition' "
                "'LDFLAGS= -fno-semantic-interposition' 'CPPFLAGS=-Os "
                "-fomit-frame-pointer'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/buildozer/aports/main/python3/src/Python-3.9.5/coverage.info',
 'COVERAGE_REPORT': '/home/buildozer/aports/main/python3/src/Python-3.9.5/lcov-report',
 ...
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXT_SUFFIX': '.cpython-39-arm-linux-musleabihf.so',
 'FILEMODE': 644,
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'armv7-alpine-linux-musleabihf',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -shared -fno-semantic-interposition  '
             '-fno-semantic-interposition',
 'LDVERSION': '3.9',
 'LIBC': '',
 ...
 'LIBPL': '/usr/lib/python3.9/config-3.9-arm-linux-musleabihf',
 'LIBPYTHON': '',
 ...
 'MODULE_OBJS': '\\',
 'MULTIARCH': 'arm-linux-musleabihf',
 'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"arm-linux-musleabihf\\"',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g '
                             '-fwrapv -O3 -Wall -fomit-frame-pointer -g '
                             '-fno-semantic-interposition  '
                             '-fomit-frame-pointer -g '
                             '-fno-semantic-interposition -fomit-frame-pointer '
                             '-g -fno-semantic-interposition '
                             '-DTHREAD_STACK_SIZE=0x100000 -flto=4 '
                             ...
                             '-I./Include -Os -fomit-frame-pointer -Os '
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
              ...
              '-fomit-frame-pointer -g -fno-semantic-interposition '
              '-DTHREAD_STACK_SIZE=0x100000',
 'PY_CFLAGS_NODIST': '-flto=4 -fuse-linker-plugin -ffat-lto-objects '
                     '-flto-partition=none -g -std=c99 -Wextra '
                     '-Wno-unused-result -Wno-unused-parameter '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -fomit-frame-pointer -g -fno-semantic-interposition  '
                   '-fomit-frame-pointer -g -fno-semantic-interposition '
                   '-fomit-frame-pointer -g -fno-semantic-interposition '
                   '-DTHREAD_STACK_SIZE=0x100000 -flto=4 -fuse-linker-plugin '
 ...
 'PY_CORE_LDFLAGS': '-fno-semantic-interposition  -fno-semantic-interposition '
 ...
 'PY_LDFLAGS_NODIST': '-flto=4 -fuse-linker-plugin -ffat-lto-objects '
                      '-flto-partition=none -g',
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -fomit-frame-pointer -g '
                        '-fno-semantic-interposition  -fomit-frame-pointer -g '
                        '-fno-semantic-interposition -fomit-frame-pointer -g '
                        '-fno-semantic-interposition '
                        '-DTHREAD_STACK_SIZE=0x100000 -flto=4 '
                        '-fuse-linker-plugin -ffat-lto-objects '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.9.5',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-39-arm-linux-musleabihf',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.9.5 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.9.5 '
 ...
 'abs_builddir': '/home/buildozer/aports/main/python3/src/Python-3.9.5',
 'abs_srcdir': '/home/buildozer/aports/main/python3/src/Python-3.9.5',
